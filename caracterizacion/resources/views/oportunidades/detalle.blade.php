...
@section('content')
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <select name="responsable_id" id="responsable_id" class="form-control @error('responsable_id') is-invalid @enderror" disabled>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <select name="cod_oportunidad" id="cod_oportunidad" class="form-control @error('cod_oportunidad') is-invalid @enderror" disabled>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            ...
            value="{{ isset($oportunidad->fecha_origen)?$oportunidad->fecha_origen:old('fecha_origen') }}" disabled>
            @error('fecha_origen')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <textarea type="text" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" disabled 
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            ...
            value="{{ isset($oportunidad->compromiso_aleado)?$oportunidad->compromiso_aleado:old('compromiso_aleado') }}" disabled>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            ...
            value="{{ isset($oportunidad->compromiso_centro)?$oportunidad->compromiso_centro:old('compromiso_centro') }}" disabled>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            ...
            value="{{ isset($oportunidad->resultado_relacional)?$oportunidad->resultado_relacional:old('resultado_relacional') }}" disabled>
